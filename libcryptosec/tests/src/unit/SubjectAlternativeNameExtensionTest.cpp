...
/**
 * @brief Testes unitários da classe SubjectAlternativeNameExtension
 */
...
protected:
    ...
    void testXmlEncoded(SubjectAlternativeNameExtension ext) {
      std::string expected = "<subjectAlternativeName>\n" +
        std::string("\t<extnID>subjectAltName</extnID>\n") +
    ...
    void testXmlEncodedTab(SubjectAlternativeNameExtension ext) {
    ...
    void testValue2XmlTab(SubjectAlternativeNameExtension ext) {
      std::string expected = tab + "<generalNames>\n" +
        tab + "\t<otherName>\n" +
        tab + "\t\t2.16.76.1.3.3 : 00000000000100\n" +
        tab + "\t</otherName>\n" +
...
TEST_F(SubjectAlternativeNameExtensionTest, Xml) {
  testXmlEncoded(extensionConstructor());
}

TEST_F(SubjectAlternativeNameExtensionTest, XmlTab) {
  testXmlEncodedTab(extensionConstructor());
}

TEST_F(SubjectAlternativeNameExtensionTest, XmlEmpty) {
  testXmlEncodedEmpty();
}

TEST_F(SubjectAlternativeNameExtensionTest, ExtValue2Xml) {
  testValue2Xml(extensionConstructor());
}

TEST_F(SubjectAlternativeNameExtensionTest, ExtValue2XmlTab) {
  testValue2XmlTab(extensionConstructor());
}

TEST_F(SubjectAlternativeNameExtensionTest, ExtValue2XmlEmpty) {
  testValue2XmlEmpty();
}
